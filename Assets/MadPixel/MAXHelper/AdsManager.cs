...
namespace MAXHelper {
    public class AdsManager : MonoBehaviour {
        ...
        /// </summary>
        public static void CancelAllAds() { // NOTE: On AdsFree bought or On AdsFree checked at game start
            if (Exist) {
        ...
        #region EditorRelated
#if UNITY_EDITOR
        public void SetCustomSettings(MAXCustomSettings newSettings) {
